...
proc create_hier_cell_opfb { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 istream_data

  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 lane_0

  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 output_0
...
proc create_root_design { parentCell } {
  ...
  # Create instance: rst_opfb_debug_2_399M, and set properties
  set rst_opfb_debug_2_399M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_opfb_debug_2_399M ]
  set_property -dict [ list \
   CONFIG.RESET_BOARD_INTERFACE {Custom} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $rst_opfb_debug_2_399M
  ...
  # Create interface connections
connect_bd_intf_net -intf_net Conn [get_bd_intf_pins opfb/output_0] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins opfb/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins opfb/istream_data] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins opfb/lane_0] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins opfb/aclk] [get_bd_pins rst_opfb_debug_2_399M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net rst_opfb_debug_2_399M_peripheral_aresetn [get_bd_pins rst_opfb_debug_2_399M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins xlconstant_0/dout]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins rst_opfb_debug_2_399M/ext_reset_in] [get_bd_pins rst_ps8_0_99M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
