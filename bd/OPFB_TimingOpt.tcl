...
################################################################
# This is a generated script based on design: no_slice_regs_before_firs_test
#
...
set design_name OPFB_TimingOpt
...
proc create_hier_cell_opfb { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net adc_to_opfb_0_lane [get_bd_intf_pins adc_to_opfb_0/lane] [get_bd_intf_pins axis_register_slice_52/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M00_AXIS [get_bd_intf_pins axis_broadcaster_1/M00_AXIS] [get_bd_intf_pins axis_register_slice_20/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M01_AXIS [get_bd_intf_pins axis_broadcaster_1/M01_AXIS] [get_bd_intf_pins axis_register_slice_21/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M02_AXIS [get_bd_intf_pins axis_broadcaster_1/M02_AXIS] [get_bd_intf_pins axis_register_slice_22/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M03_AXIS [get_bd_intf_pins axis_broadcaster_1/M03_AXIS] [get_bd_intf_pins axis_register_slice_23/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M04_AXIS [get_bd_intf_pins axis_broadcaster_1/M04_AXIS] [get_bd_intf_pins axis_register_slice_24/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M05_AXIS [get_bd_intf_pins axis_broadcaster_1/M05_AXIS] [get_bd_intf_pins axis_register_slice_25/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M06_AXIS [get_bd_intf_pins axis_broadcaster_1/M06_AXIS] [get_bd_intf_pins axis_register_slice_26/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M07_AXIS [get_bd_intf_pins axis_broadcaster_1/M07_AXIS] [get_bd_intf_pins axis_register_slice_27/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M08_AXIS [get_bd_intf_pins axis_broadcaster_1/M08_AXIS] [get_bd_intf_pins axis_register_slice_28/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M09_AXIS [get_bd_intf_pins axis_broadcaster_1/M09_AXIS] [get_bd_intf_pins axis_register_slice_29/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M10_AXIS [get_bd_intf_pins axis_broadcaster_1/M10_AXIS] [get_bd_intf_pins axis_register_slice_30/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M11_AXIS [get_bd_intf_pins axis_broadcaster_1/M11_AXIS] [get_bd_intf_pins axis_register_slice_31/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M12_AXIS [get_bd_intf_pins axis_broadcaster_1/M12_AXIS] [get_bd_intf_pins axis_register_slice_32/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M13_AXIS [get_bd_intf_pins axis_broadcaster_1/M13_AXIS] [get_bd_intf_pins axis_register_slice_33/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M14_AXIS [get_bd_intf_pins axis_broadcaster_1/M14_AXIS] [get_bd_intf_pins axis_register_slice_34/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M15_AXIS [get_bd_intf_pins axis_broadcaster_1/M15_AXIS] [get_bd_intf_pins axis_register_slice_35/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M00_AXIS [get_bd_intf_pins axis_broadcaster_2/M00_AXIS] [get_bd_intf_pins axis_register_slice_36/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M01_AXIS [get_bd_intf_pins axis_broadcaster_2/M01_AXIS] [get_bd_intf_pins axis_register_slice_37/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M02_AXIS [get_bd_intf_pins axis_broadcaster_2/M02_AXIS] [get_bd_intf_pins axis_register_slice_38/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M03_AXIS [get_bd_intf_pins axis_broadcaster_2/M03_AXIS] [get_bd_intf_pins axis_register_slice_39/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M04_AXIS [get_bd_intf_pins axis_broadcaster_2/M04_AXIS] [get_bd_intf_pins axis_register_slice_40/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M05_AXIS [get_bd_intf_pins axis_broadcaster_2/M05_AXIS] [get_bd_intf_pins axis_register_slice_41/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M06_AXIS [get_bd_intf_pins axis_broadcaster_2/M06_AXIS] [get_bd_intf_pins axis_register_slice_42/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M07_AXIS [get_bd_intf_pins axis_broadcaster_2/M07_AXIS] [get_bd_intf_pins axis_register_slice_43/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M08_AXIS [get_bd_intf_pins axis_broadcaster_2/M08_AXIS] [get_bd_intf_pins axis_register_slice_44/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M09_AXIS [get_bd_intf_pins axis_broadcaster_2/M09_AXIS] [get_bd_intf_pins axis_register_slice_45/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M10_AXIS [get_bd_intf_pins axis_broadcaster_2/M10_AXIS] [get_bd_intf_pins axis_register_slice_46/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M11_AXIS [get_bd_intf_pins axis_broadcaster_2/M11_AXIS] [get_bd_intf_pins axis_register_slice_47/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M12_AXIS [get_bd_intf_pins axis_broadcaster_2/M12_AXIS] [get_bd_intf_pins axis_register_slice_48/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M13_AXIS [get_bd_intf_pins axis_broadcaster_2/M13_AXIS] [get_bd_intf_pins axis_register_slice_49/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M14_AXIS [get_bd_intf_pins axis_broadcaster_2/M14_AXIS] [get_bd_intf_pins axis_register_slice_50/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M15_AXIS [get_bd_intf_pins axis_broadcaster_2/M15_AXIS] [get_bd_intf_pins axis_register_slice_51/S_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS [get_bd_intf_pins axis_combiner_0/M_AXIS] [get_bd_intf_pins axis_register_slice_54/S_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_10_M_AXIS [get_bd_intf_pins axis_combiner_0/S07_AXIS] [get_bd_intf_pins axis_register_slice_10/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_11_M_AXIS [get_bd_intf_pins axis_combiner_0/S08_AXIS] [get_bd_intf_pins axis_register_slice_11/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_12_M_AXIS [get_bd_intf_pins axis_combiner_0/S09_AXIS] [get_bd_intf_pins axis_register_slice_12/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_13_M_AXIS [get_bd_intf_pins axis_combiner_0/S10_AXIS] [get_bd_intf_pins axis_register_slice_13/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_14_M_AXIS [get_bd_intf_pins axis_combiner_0/S11_AXIS] [get_bd_intf_pins axis_register_slice_14/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_15_M_AXIS [get_bd_intf_pins axis_combiner_0/S12_AXIS] [get_bd_intf_pins axis_register_slice_15/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_16_M_AXIS [get_bd_intf_pins axis_combiner_0/S13_AXIS] [get_bd_intf_pins axis_register_slice_16/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_17_M_AXIS [get_bd_intf_pins axis_combiner_0/S14_AXIS] [get_bd_intf_pins axis_register_slice_17/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_18_M_AXIS [get_bd_intf_pins axis_combiner_0/S15_AXIS] [get_bd_intf_pins axis_register_slice_18/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_19_M_AXIS [get_bd_intf_pins output_r] [get_bd_intf_pins axis_register_slice_19/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_1_M_AXIS [get_bd_intf_pins adc_to_opfb_0/istream_V] [get_bd_intf_pins axis_register_slice_1/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_20_M_AXIS [get_bd_intf_pins axis_register_slice_20/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA]
  connect_bd_intf_net -intf_net axis_register_slice_21_M_AXIS [get_bd_intf_pins axis_register_slice_21/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA1]
  connect_bd_intf_net -intf_net axis_register_slice_22_M_AXIS [get_bd_intf_pins axis_register_slice_22/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA2]
  connect_bd_intf_net -intf_net axis_register_slice_23_M_AXIS [get_bd_intf_pins axis_register_slice_23/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA3]
  connect_bd_intf_net -intf_net axis_register_slice_24_M_AXIS [get_bd_intf_pins axis_register_slice_24/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA4]
  connect_bd_intf_net -intf_net axis_register_slice_25_M_AXIS [get_bd_intf_pins axis_register_slice_25/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA5]
  connect_bd_intf_net -intf_net axis_register_slice_26_M_AXIS [get_bd_intf_pins axis_register_slice_26/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA6]
  connect_bd_intf_net -intf_net axis_register_slice_27_M_AXIS [get_bd_intf_pins axis_register_slice_27/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA7]
  connect_bd_intf_net -intf_net axis_register_slice_28_M_AXIS [get_bd_intf_pins axis_register_slice_28/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA8]
  connect_bd_intf_net -intf_net axis_register_slice_29_M_AXIS [get_bd_intf_pins axis_register_slice_29/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA9]
  connect_bd_intf_net -intf_net axis_register_slice_2_M_AXIS [get_bd_intf_pins adc_to_opfb_0/qstream_V] [get_bd_intf_pins axis_register_slice_2/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_30_M_AXIS [get_bd_intf_pins axis_register_slice_30/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA10]
  connect_bd_intf_net -intf_net axis_register_slice_31_M_AXIS [get_bd_intf_pins axis_register_slice_31/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA11]
  connect_bd_intf_net -intf_net axis_register_slice_32_M_AXIS [get_bd_intf_pins axis_register_slice_32/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA12]
  connect_bd_intf_net -intf_net axis_register_slice_33_M_AXIS [get_bd_intf_pins axis_register_slice_33/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA13]
  connect_bd_intf_net -intf_net axis_register_slice_34_M_AXIS [get_bd_intf_pins axis_register_slice_34/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA14]
  connect_bd_intf_net -intf_net axis_register_slice_35_M_AXIS [get_bd_intf_pins axis_register_slice_35/M_AXIS] [get_bd_intf_pins filters/S_AXIS_DATA15]
  connect_bd_intf_net -intf_net axis_register_slice_36_M_AXIS [get_bd_intf_pins axis_register_slice_36/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_0]
  connect_bd_intf_net -intf_net axis_register_slice_37_M_AXIS [get_bd_intf_pins axis_register_slice_37/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_1]
  connect_bd_intf_net -intf_net axis_register_slice_38_M_AXIS [get_bd_intf_pins axis_register_slice_38/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_2]
  connect_bd_intf_net -intf_net axis_register_slice_39_M_AXIS [get_bd_intf_pins axis_register_slice_39/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_3]
  connect_bd_intf_net -intf_net axis_register_slice_3_M_AXIS [get_bd_intf_pins axis_combiner_0/S00_AXIS] [get_bd_intf_pins axis_register_slice_3/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_40_M_AXIS [get_bd_intf_pins axis_register_slice_40/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_4]
  connect_bd_intf_net -intf_net axis_register_slice_41_M_AXIS [get_bd_intf_pins axis_register_slice_41/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_5]
  connect_bd_intf_net -intf_net axis_register_slice_42_M_AXIS [get_bd_intf_pins axis_register_slice_42/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_6]
  connect_bd_intf_net -intf_net axis_register_slice_43_M_AXIS [get_bd_intf_pins axis_register_slice_43/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_7]
  connect_bd_intf_net -intf_net axis_register_slice_44_M_AXIS [get_bd_intf_pins axis_register_slice_44/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_8]
  connect_bd_intf_net -intf_net axis_register_slice_45_M_AXIS [get_bd_intf_pins axis_register_slice_45/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_9]
  connect_bd_intf_net -intf_net axis_register_slice_46_M_AXIS [get_bd_intf_pins axis_register_slice_46/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_10]
  connect_bd_intf_net -intf_net axis_register_slice_47_M_AXIS [get_bd_intf_pins axis_register_slice_47/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_11]
  connect_bd_intf_net -intf_net axis_register_slice_48_M_AXIS [get_bd_intf_pins axis_register_slice_48/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_12]
  connect_bd_intf_net -intf_net axis_register_slice_49_M_AXIS [get_bd_intf_pins axis_register_slice_49/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_13]
  connect_bd_intf_net -intf_net axis_register_slice_4_M_AXIS [get_bd_intf_pins axis_combiner_0/S01_AXIS] [get_bd_intf_pins axis_register_slice_4/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_50_M_AXIS [get_bd_intf_pins axis_register_slice_50/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_14]
  connect_bd_intf_net -intf_net axis_register_slice_51_M_AXIS [get_bd_intf_pins axis_register_slice_51/M_AXIS] [get_bd_intf_pins ssrfft_16x4096_axis_0/iq_15]
  connect_bd_intf_net -intf_net axis_register_slice_52_M_AXIS [get_bd_intf_pins axis_broadcaster_1/S_AXIS] [get_bd_intf_pins axis_register_slice_52/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_53_M_AXIS [get_bd_intf_pins axis_broadcaster_2/S_AXIS] [get_bd_intf_pins axis_register_slice_53/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_54_M_AXIS [get_bd_intf_pins axis_register_slice_54/M_AXIS] [get_bd_intf_pins fir_to_fft_0/input_r]
  connect_bd_intf_net -intf_net axis_register_slice_5_M_AXIS [get_bd_intf_pins axis_combiner_0/S02_AXIS] [get_bd_intf_pins axis_register_slice_5/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_6_M_AXIS [get_bd_intf_pins axis_combiner_0/S03_AXIS] [get_bd_intf_pins axis_register_slice_6/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_7_M_AXIS [get_bd_intf_pins axis_combiner_0/S04_AXIS] [get_bd_intf_pins axis_register_slice_7/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_8_M_AXIS [get_bd_intf_pins axis_combiner_0/S05_AXIS] [get_bd_intf_pins axis_register_slice_8/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_9_M_AXIS [get_bd_intf_pins axis_combiner_0/S06_AXIS] [get_bd_intf_pins axis_register_slice_9/M_AXIS]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA [get_bd_intf_pins axis_register_slice_3/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA1 [get_bd_intf_pins axis_register_slice_4/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA1]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA2 [get_bd_intf_pins axis_register_slice_5/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA2]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA3 [get_bd_intf_pins axis_register_slice_6/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA3]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA4 [get_bd_intf_pins axis_register_slice_7/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA4]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA5 [get_bd_intf_pins axis_register_slice_8/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA5]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA6 [get_bd_intf_pins axis_register_slice_9/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA6]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA7 [get_bd_intf_pins axis_register_slice_10/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA7]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA8 [get_bd_intf_pins axis_register_slice_11/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA8]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA9 [get_bd_intf_pins axis_register_slice_12/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA9]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA10 [get_bd_intf_pins axis_register_slice_13/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA10]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA11 [get_bd_intf_pins axis_register_slice_14/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA11]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA12 [get_bd_intf_pins axis_register_slice_15/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA12]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA13 [get_bd_intf_pins axis_register_slice_16/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA13]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA14 [get_bd_intf_pins axis_register_slice_17/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA14]
  connect_bd_intf_net -intf_net filters_M_AXIS_DATA15 [get_bd_intf_pins axis_register_slice_18/S_AXIS] [get_bd_intf_pins filters/M_AXIS_DATA15]
  connect_bd_intf_net -intf_net fir_to_fft_0_output_r [get_bd_intf_pins axis_register_slice_53/S_AXIS] [get_bd_intf_pins fir_to_fft_0/output_r]
  connect_bd_intf_net -intf_net pkg_fft_output_0_output_r [get_bd_intf_pins axis_register_slice_19/S_AXIS] [get_bd_intf_pins pkg_fft_output_0/output_r]

  # Create port connections
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins adc_to_opfb_0/ap_rst_n] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_broadcaster_2/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_10/aresetn] [get_bd_pins axis_register_slice_11/aresetn] [get_bd_pins axis_register_slice_12/aresetn] [get_bd_pins axis_register_slice_13/aresetn] [get_bd_pins axis_register_slice_14/aresetn] [get_bd_pins axis_register_slice_15/aresetn] [get_bd_pins axis_register_slice_16/aresetn] [get_bd_pins axis_register_slice_17/aresetn] [get_bd_pins axis_register_slice_18/aresetn] [get_bd_pins axis_register_slice_19/aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins axis_register_slice_20/aresetn] [get_bd_pins axis_register_slice_21/aresetn] [get_bd_pins axis_register_slice_22/aresetn] [get_bd_pins axis_register_slice_23/aresetn] [get_bd_pins axis_register_slice_24/aresetn] [get_bd_pins axis_register_slice_25/aresetn] [get_bd_pins axis_register_slice_26/aresetn] [get_bd_pins axis_register_slice_27/aresetn] [get_bd_pins axis_register_slice_28/aresetn] [get_bd_pins axis_register_slice_29/aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins axis_register_slice_30/aresetn] [get_bd_pins axis_register_slice_31/aresetn] [get_bd_pins axis_register_slice_32/aresetn] [get_bd_pins axis_register_slice_33/aresetn] [get_bd_pins axis_register_slice_34/aresetn] [get_bd_pins axis_register_slice_35/aresetn] [get_bd_pins axis_register_slice_36/aresetn] [get_bd_pins axis_register_slice_37/aresetn] [get_bd_pins axis_register_slice_38/aresetn] [get_bd_pins axis_register_slice_39/aresetn] [get_bd_pins axis_register_slice_4/aresetn] [get_bd_pins axis_register_slice_40/aresetn] [get_bd_pins axis_register_slice_41/aresetn] [get_bd_pins axis_register_slice_42/aresetn] [get_bd_pins axis_register_slice_43/aresetn] [get_bd_pins axis_register_slice_44/aresetn] [get_bd_pins axis_register_slice_45/aresetn] [get_bd_pins axis_register_slice_46/aresetn] [get_bd_pins axis_register_slice_47/aresetn] [get_bd_pins axis_register_slice_48/aresetn] [get_bd_pins axis_register_slice_49/aresetn] [get_bd_pins axis_register_slice_5/aresetn] [get_bd_pins axis_register_slice_50/aresetn] [get_bd_pins axis_register_slice_51/aresetn] [get_bd_pins axis_register_slice_52/aresetn] [get_bd_pins axis_register_slice_53/aresetn] [get_bd_pins axis_register_slice_54/aresetn] [get_bd_pins axis_register_slice_6/aresetn] [get_bd_pins axis_register_slice_7/aresetn] [get_bd_pins axis_register_slice_8/aresetn] [get_bd_pins axis_register_slice_9/aresetn] [get_bd_pins filters/aresetn] [get_bd_pins fir_to_fft_0/ap_rst_n] [get_bd_pins pkg_fft_output_0/ap_rst_n] [get_bd_pins xlconstant_1/dout]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {151.531} \
   CONFIG.CLKOUT1_PHASE_ERROR {320.731} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXIS1_1 [get_bd_intf_pins axis_register_slice_2/M_AXIS] [get_bd_intf_pins opfb/S_AXIS1]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins axis_register_slice_2/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_1_M_AXIS [get_bd_intf_pins axis_register_slice_1/M_AXIS] [get_bd_intf_pins opfb/S_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_3_M_AXIS [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins axis_register_slice_3/M_AXIS]
  connect_bd_intf_net -intf_net opfb_output_r [get_bd_intf_pins axis_register_slice_3/S_AXIS] [get_bd_intf_pins opfb/output_r]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins opfb/aclk]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins xlconstant_3/dout]
